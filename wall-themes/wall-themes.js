 ...
 *
 * 三个第一阶段主题：
 *   felt（默认，毛毡照片板，📌 图钉）— 奶油白 / 鼠尾草绿 / 雾霾蓝-樱花粉 三色变体
    ...
    window.PAW_WALL_THEMES = [
        {
            ...
            variants: [
                ...
                { id: 'misty', name: '雾霾蓝-樱花粉', file: 'backgrounds/felt-misty.webp', overlay: 'linear-gradient(180deg, rgba(224,232,240,0.08), rgba(205,180,200,0.24))', accent: '#8AA0BC', titleColor: '#3F4E63' }
            ]
        },
        {
            id: 'cork',
